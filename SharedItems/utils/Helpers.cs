...
namespace HttpClientSample
{
    internal static class Helpers
    {
        ...
        internal static string SerializeHeaders(HttpResponseMessage response)
        {
            ...
            // name of the enumerates (e.g., "OK") which would often be redundant with the ReasonPhrase.
            output.Append((int)response.StatusCode).Append(' ').Append(response.ReasonPhrase).Append("\r\n");
